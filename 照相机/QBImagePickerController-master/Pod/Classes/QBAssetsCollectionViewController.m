    ...
    if (kind == UICollectionElementKindSectionFooter) {
        ...
        switch (self.filterType) {
            case QBImagePickerControllerFilterTypeNone:{
                ...
                footerView.textLabel.text = [NSString stringWithFormat:format, @"QBImagePickerController",[NSBundle bundleWithPath:[[NSBundle mainBundle] pathForResource:@"QBImagePickerController" ofType:@"bundle"]], nil,self.numberOfPhotos,
                                             self.numberOfVideos
                                             ];
                break;
            }
